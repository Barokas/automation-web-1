...
exports.config = {
    ...
    before: function () {
        ...
        driver = create_webdirver(serverUrl, browser.sessionId);
        ...
        browser.addCommand("EyesOpen", function (testName, appName) {
            ...
            eyes.open(driver, "Airtasker", testName, {width: EYES_VIEWPORT_WIDTH, height: EYES_VIEWPORT_HEIGHT});
        });

        browser.addCommand("EyesCheckWindow", function async(tag) {
            console.log("** Visually Checking Page: " + tag + " **");
            return eyes.checkWindow(tag);
        });
	
        browser.addCommand("EyesClose", function async(throwEx) {
            
			// console.log("Is Eyes Open? => " + global.eyesIsOpen)
			
			if (global.eyesIsOpen === true) {
