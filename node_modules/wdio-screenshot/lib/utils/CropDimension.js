...
var CropDimension = function () {
  function CropDimension(width, height, x, y) {
    var pixelRatio = arguments.length <= 4 || arguments[4] === undefined ? 1 : arguments[4];
    var top = arguments.length <= 5 || arguments[5] === undefined ? true : arguments[5];
    var rotation = arguments.length <= 6 || arguments[6] === undefined ? 0 : arguments[6];
